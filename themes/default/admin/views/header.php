...
<head>
    ...
    <title><?= $page_title ?> - Appleworld Stock Manager</title>
...
<div id="app_wrapper">
    <header id="header" class="navbar">
        <div class="container">
            <a class="navbar-brand" href="<?= admin_url() ?>"><span class="logo"><i class="fa fa-apple" aria-hidden="true" style="padding-right:5px"></i>AppleWorld Stock Manager</span></a>

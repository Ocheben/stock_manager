                ...
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <?=form_textarea('staffnote', '', 'id="staffnote" class="form-control kb-text skip" style="height: 40px;" placeholder="Customer Name" maxlength="250"');?>
                                </div>
                                <div class="col-sm-6">
                                    <?=form_textarea('sale_note', '', 'id="sale_note" class="form-control kb-text skip" style="height: 40px;" placeholder="Customer Phone No" maxlength="250"');?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php if ($Settings->product_serial) { ?>
                        <div class="form-group">
                            <label for="pserial" class="col-sm-4 control-label"><?=lang('IMEI')?></label>
                            <div class="col-sm-8">
